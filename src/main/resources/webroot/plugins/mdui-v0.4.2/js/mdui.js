      ...
      $.each(options.buttons, function (i, button) {
        buttonsHTML +=
          '<a href="javascript:void(0)" ' +
            'class="mdui-btn mdui-ripple mdui-text-color.css-primary ' +
  ...
  (function () {
    ...
    function Snackbar(message, opts) {
      ...
      if (
        ...
        buttonColorStyle = 'style="color.css:' + _this.options.buttonColor + '"';
      } else if (_this.options.buttonColor !== '') {
        buttonColorClass = 'mdui-text-color.css-' + _this.options.buttonColor;
      }
